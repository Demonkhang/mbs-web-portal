...
export const PERMISSION_CATALOG = [
  ...
  },
  {
    ...
    permissions: [
      { code: 'posts:view', title: 'Xem danh sách tin bài', description: 'Xem danh sách bài viết nháp, duyệt, xuất bản' },
      { code: 'posts:create', title: 'Soạn thảo bài viết mới', description: 'Tạo bài viết ở trạng thái Nháp' },
      ...
      { code: 'posts:review', title: 'Trình duyệt tin bài', description: 'Gửi bài viết lên cấp Trưởng ban duyệt' },
      { code: 'posts:approve', title: 'Phê duyệt xuất bản', description: 'Xuất bản bài viết lên Portal công khai' },
