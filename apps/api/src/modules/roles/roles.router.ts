...
export const PERMISSION_CATALOG = [
  {
    ...
    permissions: [
      ...
      { code: 'directory:manage', title: 'Quản lý Danh bạ Điện tử Cán bộ & Phòng ban', description: 'Toàn quyền cấu hình Đơn vị, Phòng ban, Cán bộ máy lẻ hiển thị trên Portal' },
  ...
  },
  {
    ...
    permissions: [
      { code: 'schedules:view', title: 'Xem lịch công tác tuần', description: 'Xem danh sách lịch làm việc tuần của Lãnh đạo' },
      { code: 'schedules:import', title: 'Import lịch tuần từ Excel', description: 'Đăng tải và bóc tách dữ liệu lịch tuần từ file Excel' },
      { code: 'schedules:create', title: 'Thêm mới lịch làm việc', description: 'Tạo thủ công sự kiện lịch công tác mới' },
      { code: 'schedules:edit', title: 'Sửa lịch công tác', description: 'Chỉnh sửa thời gian, nội dung, chủ trì, địa điểm' },
      { code: 'schedules:delete', title: 'Xóa lịch công tác', description: 'Xóa sự kiện hoặc xóa toàn bộ lịch của 1 tuần' },
      { code: 'schedules:publish', title: 'Duyệt công khai lịch tuần', description: 'Bật/Tắt chế độ công khai lịch tuần trên Portal' },
      { code: 'schedules:manage', title: 'Quản lý Lịch làm việc tuần (Toàn quyền)', description: 'Toàn quyền đăng, sửa, xóa và import lịch công tác Ban Giám đốc' },
